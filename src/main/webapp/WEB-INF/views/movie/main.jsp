...
<body>
	...
	<div class="container pb-4">
		...
		<div id="genreSearch" class="row px-3 pb-3">
			...
			<form id="genreSelector" class="mx-3"
				action="${root}/movie/setView.mn"
				onsubmit="genreCheck(this);">
				...
				<input type="hidden" name="lastId" value="${array[19].id}" >
			...
			<c:forEach var="movie" items="${array}">
				<div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
					...
					<div class="card h-100">
						<!-- Card image -->
						<a href="${root}/movie/fullView.mn?movieId=${movie.id}"> <!-- 포스터 -->
		...
		<ul class="pagination justify-content-center">
			...
			<fmt:parseNumber var="temp" value="${movieListCount/listSize}"
				integerOnly="true" />
			<c:set var="pageCount"
				value="${temp + (movieListCount % listSize == 0 ? 0 : 1)}" />
