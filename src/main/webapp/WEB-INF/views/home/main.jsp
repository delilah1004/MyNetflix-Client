...
<head>
	...
	<link rel="stylesheet" type="text/css"
		href="${root}/resources/slick/slick.css">
	<link rel="stylesheet" type="text/css"
		href="${root}/resources/slick/slick-theme.css">
	
	<!-- Netflix Slider -->
	<link rel="stylesheet" type="text/css"
		href="${root}/resources/css/netflix_slider.css">
...
<body>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('//image.tmdb.org/t/p/w1920_and_h800_multi_faces/ta5oblpMlEcIPIS2YGcq9XEkWK2.jpg')">
				...
				<div class="carousel-item"
					style="background-image: url('//image.tmdb.org/t/p/w1920_and_h800_multi_faces/xGexTKCJDkl12dTW4YCBDXWb1AD.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h3>종이의 집</h3>
					</div>
				</div>
				...
				<div class="carousel-item"
					style="background-image: url('//image.tmdb.org/t/p/w1920_and_h800_multi_faces/hTExot1sfn7dHZjGrk0Aiwpntxt.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h3>원헌드레드</h3>
					</div>
				</div>
	...
	<script src="${root}/resources/slick/slick.js" type="text/javascript"
		charset="utf-8"></script>

	<!-- netflix slider -->
	<script src="${root}/resources/js/netflix_slider.js"
