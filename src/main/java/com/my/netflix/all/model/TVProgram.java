...
public class TVProgram {
    ...
    @Override public String toString() {
        return "TVProgram [id=" + id + ", name=" + name + ", episodeRunTime=" +
                episodeRunTime + ", genreIds=" + genreIds + ", genreNames=" +
                genreNames + ", overview=" + overview + ", posterPath=" + posterPath + ", homep" +
                "age=" + homepage + ", firstAirDate=" + firstAirDate + ", lastAirDate=" +
                lastAirDate + ", popularity=" + popularity + ", seasons=" + seasons +
                ", status=" + status + "]";
    }
