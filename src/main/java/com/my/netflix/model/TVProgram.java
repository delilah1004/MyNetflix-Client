...
public class TVProgram {
	...
	public String toString() {
		return "TVProgram{" + "id=" + id + ", name='" + name + '\'' + ", episodeRunTime='" + episodeRunTime + '\''
				+ ", genres=" + genres + ", overview='" + overview + '\'' + ", posterPath='" + posterPath + '\''
				+ ", homepage='" + homepage + '\'' + ", firstAirDate='" + firstAirDate + '\'' + ", lastAirDate='"
				+ lastAirDate + '\'' + ", popularity=" + popularity + ", seasons=" + seasons + ", status='" + status
				+ '\'' + '}';
	}
}
